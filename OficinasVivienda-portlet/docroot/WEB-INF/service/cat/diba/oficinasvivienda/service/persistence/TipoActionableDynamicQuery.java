 ...
 * @generated
 */
public abstract class TipoActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public TipoActionableDynamicQuery() throws SystemException {
		setBaseLocalService(TipoLocalServiceUtil.getService());
		setClass(Tipo.class);

		setClassLoader(cat.diba.oficinasvivienda.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("idTipo");
	}
}