 ...
 * @generated
 */
public abstract class OficinaServicioMunicipioActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public OficinaServicioMunicipioActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(OficinaServicioMunicipioLocalServiceUtil.getService());
		setClass(OficinaServicioMunicipio.class);
