...
/**
 * Provides the local service interface for OficinaServicioMunicipio. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author gonzalezscr
 * @see OficinaServicioMunicipioLocalServiceUtil
...
public interface OficinaServicioMunicipioLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OficinaServicioMunicipioLocalServiceUtil} to access the oficina servicio municipio local service. Add custom service methods to {@link cat.diba.oficinasvivienda.service.impl.OficinaServicioMunicipioLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
