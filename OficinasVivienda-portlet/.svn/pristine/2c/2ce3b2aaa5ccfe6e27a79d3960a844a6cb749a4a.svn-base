...
public class ServicioLocalServiceWrapper implements ServicioLocalService,
	...
	*/
	...
	public cat.diba.oficinasvivienda.model.Servicio nuevoServicio(
		cat.diba.oficinasvivienda.model.Servicio servicio) {
		return _servicioLocalService.nuevoServicio(servicio);
	}

	@Override
	public java.util.List<cat.diba.oficinasvivienda.model.Servicio> obtenerServicios(
		long companyId, long groupId, int start, int end) {
		return _servicioLocalService.obtenerServicios(companyId, groupId,
			start, end);
	}

	@Override
	public int obtenerServiciosTotal(long companyId, long groupId) {
		return _servicioLocalService.obtenerServiciosTotal(companyId, groupId);
	}

	@Override
	public java.util.List<cat.diba.oficinasvivienda.model.Servicio> obtenerNecesidades(
		long companyId, long groupId, int start, int end) {
		return _servicioLocalService.obtenerNecesidades(companyId, groupId,
			start, end);
	}
