...
/**
 * The base model interface for the OficinaServicioMunicipio service. Represents a row in the &quot;OfiVi_OficinaServicioMunicipio&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link cat.diba.oficinasvivienda.model.impl.OficinaServicioMunicipioModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link cat.diba.oficinasvivienda.model.impl.OficinaServicioMunicipioImpl}.
 * </p>
 *
 * @author gonzalezscr
 ...
 * @generated
 */
public interface OficinaServicioMunicipioModel extends BaseModel<OficinaServicioMunicipio> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a oficina servicio municipio model instance should use the {@link OficinaServicioMunicipio} interface instead.
	 */
	...
	@Override
	public CacheModel<cat.diba.oficinasvivienda.model.OficinaServicioMunicipio> toCacheModel();
