 ...
 * @generated
 */
public abstract class OficinaTipoActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public OficinaTipoActionableDynamicQuery() throws SystemException {
		setBaseLocalService(OficinaTipoLocalServiceUtil.getService());
		setClass(OficinaTipo.class);
