 ...
 * {@link cat.diba.oficinasvivienda.service.impl.ServicioLocalServiceImpl} and is the
...
public class ServicioLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link cat.diba.oficinasvivienda.service.impl.ServicioLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static cat.diba.oficinasvivienda.model.Servicio addServicio(
	...
	*/
	public static cat.diba.oficinasvivienda.model.Servicio createServicio(
		long idServicio) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static cat.diba.oficinasvivienda.model.Servicio deleteServicio(
		long idServicio)
	...
	*/
	...
	public static cat.diba.oficinasvivienda.model.Servicio fetchServicio(
		long idServicio)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static cat.diba.oficinasvivienda.model.Servicio getServicio(
		long idServicio)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<cat.diba.oficinasvivienda.model.Servicio> getServicios(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static cat.diba.oficinasvivienda.model.Servicio updateServicio(
		cat.diba.oficinasvivienda.model.Servicio servicio)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static cat.diba.oficinasvivienda.model.Servicio nuevoServicio(
		cat.diba.oficinasvivienda.model.Servicio servicio) {
		return getService().nuevoServicio(servicio);
	}

	public static java.util.List<cat.diba.oficinasvivienda.model.Servicio> obtenerServicios(
		long companyId, long groupId, int start, int end) {
		return getService().obtenerServicios(companyId, groupId, start, end);
	}

	public static int obtenerServiciosTotal(long companyId, long groupId) {
		return getService().obtenerServiciosTotal(companyId, groupId);
	}

	public static java.util.List<cat.diba.oficinasvivienda.model.Servicio> obtenerNecesidades(
		long companyId, long groupId, int start, int end) {
		return getService().obtenerNecesidades(companyId, groupId, start, end);
	}
